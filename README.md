...
[vue-typescript-admin-template](http://armour.github.io/vue-typescript-admin-template) 是一个后台前端解决方案，它基于 vue + vuex+ vue-router + element-ui + fakejs + axios + sass + eslint + typescript实现。

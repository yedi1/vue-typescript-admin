    ...
    <el-row :gutter="20" style="margin-top: 50px">
          ...
          <div style="height: 100px">
            <el-form :model="demo" :rules="demoRules">
              <el-form-item prop="title">
                <material-input id="material-input-demo" v-model="demo.title" icon="el-icon-search" name="title" placeholder="输入标题"> 标题 </material-input>
              </el-form-item>
            </el-form>
          </div>
        </el-card>
      ...
      <el-col :span="6">
        <el-card class="box-card">
          ...
          <div class="component-item">
            <pan-thumb width="100px" height="100px" image="https://wpimg.wallstcn.com/577965b9-bb9e-4e02-9f0c-095b41417191"> vue-typescript-admin </pan-thumb>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :span="6">
        <el-card class="box-card">
          ...
          <div class="component-item">
            <mallki class-name="mallki-text" text="vue-typescript-admin" />
          </div>
        </el-card>
      </el-col>
    </el-row>

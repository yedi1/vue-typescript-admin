<template>
  <div class="components-container">
    <aside>
      ...
      <a target="_blank" href="https://armour.github.io/vue-typescript-admin-docs/features/components/markdown-editor.html"> Documentation </a>
    </aside>
    ...
    <el-button type="primary" icon="el-icon-document" @click="getHtml"> Get HTML </el-button>
    <!-- eslint-disable vue/no-v-html -->
    <div v-html="html" />

    <div class="editor-container" style="margin-top: 20px">
      <el-tag class="tag-title"> Markdown Mode: </el-tag>
      <markdown-editor :initialValue="content2" :options="{ hideModeSwitch: true, previewStyle: 'tab' }" height="200px" />
    </div>

    <div class="editor-container">
      <el-tag class="tag-title"> Customize Toolbar: </el-tag>
      <markdown-editor :initialValue="content3" :options="{ toolbarItems: ['heading', 'bold', 'italic'] }" />
    </div>
